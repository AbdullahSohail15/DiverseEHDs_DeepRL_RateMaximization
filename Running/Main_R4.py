...
avg_alphan_per = [sum(alphan_all_per)/len(alphan_all_per)]
avg_alphan_cer = [sum(alphan_all_cer)/len(alphan_all_cer)]
avg_alphan_td3 = [sum(alphan_all_td3)/len(alphan_all_td3)]

######### WRITING DATA TO FILES ##########

file=open('R4_avg_alphan_arrays_td3.txt','a')
for item in avg_alphan_td3:
      file.write(str(item))
      file.write("\n")
file.close()

file=open('R4_avg_alphan_arrays_per.txt','a')
for item in avg_alphan_per:
      file.write(str(item))
      file.write("\n")
file.close()
